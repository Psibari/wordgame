  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top }]}>
      ...
      <View style={styles.inner}>
        ...
        <Text style={styles.title}>Crossroads</Text>
        <Text style={styles.sub}>Coming soon — context mode</Text>
        <TouchableOpacity style={styles.btn} onPress={onExit} activeOpacity={0.8}>
          <LinearGradient colors={['#7C5CFC', '#A487FF']} style={styles.btnGrad} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}>
...
const styles = StyleSheet.create({
  ...
  btn: { width: '100%', borderRadius: Radii.xl, overflow: 'hidden', ...Shadows.accent },
