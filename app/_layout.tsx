    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <SafeAreaProvider>
        ...
        >
          ...
          <Stack.Screen name="garden-review" />
          <Stack.Screen name="oracle" />
          <Stack.Screen name="voice-challenge" />
          <Stack.Screen name="arena-vs" options={{ animation: 'fade' }} />
          <Stack.Screen name="arena-duel" options={{ animation: 'fade' }} />
          <Stack.Screen name="arena-post-match" options={{ animation: 'fade' }} />
          <Stack.Screen name="arena-tomes" />
        </Stack>
      </SafeAreaProvider>
